...
namespace Drupal\apar_technologies_dhl_api\Form;

use Drupal\apar_technologies_dhl_api\Services\DHLHttPClientServices;
...
class DHLLocationFinderForm extends FormBase {
   ...
   *
   * @var \Drupal\apar_technologies_dhl_api\Services\DHLHttPClientServices
   */
  protected $dhlClient;
   ...
   *
   * @param \Drupal\apar_technologies_dhl_api\Services\DHLHttPClientServices $dhl_client
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($form_state->get('locations')) {
      $form['#attached']['library'][] = 'apar_technologies_dhl_api/dhl_location_output_style';
      $form['results'] = [
        '#type' => 'markup',
        '#markup' => '
